...
TASK_SPECS=()
TASK_SPECS+=("88|nep_mtp_painn_mace|4|nep mtp painn mace")
TASK_SPECS+=("89|nep_mtp_schnet_mace|4|nep mtp schnet mace")
TASK_SPECS+=("90|nep_soap_painn_schnet|4|nep soap painn schnet")
TASK_SPECS+=("91|nep_soap_painn_mace|4|nep soap painn mace")
TASK_SPECS+=("92|nep_soap_schnet_mace|4|nep soap schnet mace")
TASK_SPECS+=("93|nep_painn_schnet_mace|4|nep painn schnet mace")
TASK_SPECS+=("94|mtp_soap_painn_schnet|4|mtp soap painn schnet")
TASK_SPECS+=("95|mtp_soap_painn_mace|4|mtp soap painn mace")
