...
TASK_SPECS=()
TASK_SPECS+=("96|mtp_soap_schnet_mace|4|mtp soap schnet mace")
TASK_SPECS+=("97|mtp_painn_schnet_mace|4|mtp painn schnet mace")
TASK_SPECS+=("98|soap_painn_schnet_mace|4|soap painn schnet mace")
TASK_SPECS+=("99|dp_nep_mtp_soap_painn|5|dp nep mtp soap painn")
TASK_SPECS+=("100|dp_nep_mtp_soap_schnet|5|dp nep mtp soap schnet")
TASK_SPECS+=("101|dp_nep_mtp_soap_mace|5|dp nep mtp soap mace")
TASK_SPECS+=("102|dp_nep_mtp_painn_schnet|5|dp nep mtp painn schnet")
TASK_SPECS+=("103|dp_nep_mtp_painn_mace|5|dp nep mtp painn mace")
