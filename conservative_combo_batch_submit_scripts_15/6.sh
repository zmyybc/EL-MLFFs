...
TASK_SPECS=()
TASK_SPECS+=("46|nep_mtp_schnet|3|nep mtp schnet")
TASK_SPECS+=("47|nep_mtp_mace|3|nep mtp mace")
TASK_SPECS+=("48|nep_soap_painn|3|nep soap painn")
TASK_SPECS+=("49|nep_soap_schnet|3|nep soap schnet")
TASK_SPECS+=("50|nep_soap_mace|3|nep soap mace")
TASK_SPECS+=("51|nep_painn_schnet|3|nep painn schnet")
TASK_SPECS+=("52|nep_painn_mace|3|nep painn mace")
TASK_SPECS+=("53|nep_schnet_mace|3|nep schnet mace")
TASK_SPECS+=("54|mtp_soap_painn|3|mtp soap painn")
