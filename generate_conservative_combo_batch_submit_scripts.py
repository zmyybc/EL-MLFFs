...
BATCH_SCRIPT_OUTPUT_DIR = "conservative_combo_batch_submit_scripts_30"
        ...
        rows.append(
            {
                ...
                "combo_tag": combo_tag,
                "default_save_path": f"el-mlffs/checkpoints/meta_models/conservative_combo/{index}_{combo_tag}.pth",
            }
        )
    return rows
