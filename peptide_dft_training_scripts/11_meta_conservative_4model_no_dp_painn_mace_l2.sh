...
SAVE_PATH="${META_OUTPUT_DIR}/conservative_meta_4model_no_dp_painn_mace_l2.pth"
LOG_FILE="${LOG_DIR}/11_meta_conservative_4model_no_dp_painn_mace_l2.log"
...
echo "Launch peptide DFT conservative meta without dp/painn/mace"
