...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train a direct-fitting meta model using existing base-model checkpoints.")
    parser.add_argument(
        "--base-models",
        nargs="+",
    ...
    parser.add_argument("--save-path", default=os.path.join("checkpoints", "meta_models", "direct_meta_current_bases.pth"))
